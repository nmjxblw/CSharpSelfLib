...
public readonly struct GameStateQueryContext
{
	...
	/// <summary>The explicit target location, without defaulting to the current location.</summary>
	/// <remarks>Most code should use <see cref="F:StardewValley.Delegates.GameStateQueryContext.Location" /> instead.</remarks>
