...
public class AdventureGuild : GameLocation
{
	...
	{
		switch (base.getTileIndexAt(tileLocation, "Buildings", "1"))
		{
		case 1306:
	...
	protected override void resetLocalState()
	{
		...
		base.addOneTimeGiftBox(ItemRegistry.Create("(O)Book_Marlon"), 10, 4);
	}
	...
	public void showMonsterKillList()
	{
		...
		foreach (MonsterSlayerQuestData questData in DataLoader.MonsterSlayerQuests(Game1.content).Values)
		{
			...
			s.Append(this.killListLine(TokenParser.ParseText(questData.DisplayName), count, questData.Count));
		}
