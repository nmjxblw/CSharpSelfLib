...
public class StatKeys
{
	...
	/// <summary>How many times the player completed Junimo Kart.</summary>
	/// <remarks>This was added in Stardew Valley 1.6.9, so 1+ games completed in previous versions count as 1.</remarks>
	public const string CompletedJunimoKart = "completedJunimoKart";

	/// <summary>How many times the player completed Journey of the Prairie King.</summary>
	/// <remarks>This was added in Stardew Valley 1.6.9, so 1+ games completed in previous versions count as 1.</remarks>
	public const string CompletedPrairieKing = "completedPrairieKing";

	/// <summary>How many times the player completed Journey of the Prairie King without dying.</summary>
	/// <remarks>This was added in Stardew Valley 1.6.9, so games completed in previous versions aren't counted.</remarks>
