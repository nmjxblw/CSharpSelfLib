...
public static class ItemContextTagManager
{
	...
	public static HashSet<string> GetBaseContextTags(string itemId)
	{
		...
		if (!ItemContextTagManager.BaseTagsCache.TryGetValue(itemData.QualifiedItemId, out var tags))
		{
	...
	{
		return ItemContextTagManager.DoAllTagsMatch(tagQueryString?.Split(','), tags);
	}
