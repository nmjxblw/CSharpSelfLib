...
public class FarmerTeam : INetObject<NetFields>
{
	...
	public FarmerTeam()
	{
		this.NetFields.SetOwner(this).AddField(this.money, "money").AddField(this.totalMoneyEarned, "totalMoneyEarned")
			.AddField(this.proposals, "proposals")
			.AddField(this.luauIngredients, "luauIngredients")
			.AddField(this.grangeDisplay, "grangeDisplay")
			.AddField(this.grangeMutex.NetFields, "grangeMutex.NetFields")
			.AddField(this.festivalPropRemovalEvent, "festivalPropRemovalEvent")
			.AddField(this.friendshipData, "friendshipData")
			.AddField(this.demolishLock.NetFields, "demolishLock.NetFields")
			.AddField(this.buildLock.NetFields, "buildLock.NetFields")
			.AddField(this.movieInvitations, "movieInvitations")
			.AddField(this.movieMutex.NetFields, "movieMutex.NetFields")
			.AddField(this.requestMovieEndEvent, "requestMovieEndEvent")
			.AddField(this.endMovieEvent, "endMovieEvent")
			.AddField(this.requestSpouseSleepEvent, "requestSpouseSleepEvent")
			.AddField(this.requestNPCGoHome, "requestNPCGoHome")
			.AddField(this.useSeparateWallets, "useSeparateWallets")
			.AddField(this.individualMoney, "individualMoney")
			.AddField(this.announcedSleepingFarmers.NetFields, "announcedSleepingFarmers.NetFields")
			.AddField(this.sleepAnnounceMode, "sleepAnnounceMode")
			.AddField(this.theaterBuildDate, "theaterBuildDate")
			.AddField(this.buildingConstructedEvent, "buildingConstructedEvent")
			.AddField(this.buildingMovedEvent, "buildingMovedEvent")
			.AddField(this.buildingDemolishedEvent, "buildingDemolishedEvent")
			.AddField(this.queenOfSauceRerunWeek, "queenOfSauceRerunWeek")
			.AddField(this.lastDayQueenOfSauceRerunUpdated, "lastDayQueenOfSauceRerunUpdated")
			.AddField(this.broadcastedMail, "broadcastedMail")
			.AddField(this.constructedBuildings, "constructedBuildings")
			.AddField(this.sharedDailyLuck, "sharedDailyLuck")
			.AddField(this.spawnMonstersAtNight, "spawnMonstersAtNight")
			.AddField(this.useLegacyRandom, "useLegacyRandom")
			.AddField(this.allowChatCheats, "allowChatCheats")
			.AddField(this.hasDedicatedHost, "hasDedicatedHost")
			.AddField(this.junimoKartScores.NetFields, "junimoKartScores.NetFields")
			.AddField(this.cellarAssignments, "cellarAssignments")
			.AddField(this.synchronizedShopStock.NetFields, "synchronizedShopStock.NetFields")
			.AddField(this.junimoKartStatus.NetFields, "junimoKartStatus.NetFields")
			.AddField(this.endOfNightStatus.NetFields, "endOfNightStatus.NetFields")
			.AddField(this.festivalScoreStatus.NetFields, "festivalScoreStatus.NetFields")
			.AddField(this.sleepStatus.NetFields, "sleepStatus.NetFields")
			.AddField(this.farmhandsCanMoveBuildings, "farmhandsCanMoveBuildings")
			.AddField(this.requestPetWarpHomeEvent, "requestPetWarpHomeEvent")
			.AddField(this.ringPhoneEvent, "ringPhoneEvent")
			.AddField(this.specialOrders, "specialOrders")
			.AddField(this.returnedDonations, "returnedDonations")
			.AddField(this.returnedDonationsMutex.NetFields, "returnedDonationsMutex.NetFields")
			.AddField(this.goldenCoconutMutex.NetFields, "goldenCoconutMutex.NetFields")
			.AddField(this.requestNutDrop, "requestNutDrop")
			.AddField(this.requestSetSimpleFlag, "requestSetSimpleFlag")
			.AddField(this.requestSetMail, "requestSetMail")
			.AddField(this.limitedNutDrops, "limitedNutDrops")
			.AddField(this.availableSpecialOrders, "availableSpecialOrders")
			.AddField(this.acceptedSpecialOrderTypes, "acceptedSpecialOrderTypes")
			.AddField(this.ordersBoardMutex.NetFields, "ordersBoardMutex.NetFields")
			.AddField(this.qiChallengeBoardMutex.NetFields, "qiChallengeBoardMutex.NetFields")
			.AddField(this.completedSpecialOrders, "completedSpecialOrders")
			.AddField(this.addCharacterEvent, "addCharacterEvent")
			.AddField(this.requestAddCharacterEvent, "requestAddCharacterEvent")
			.AddField(this.requestLeoMove, "requestLeoMove")
			.AddField(this.collectedNutTracker, "collectedNutTracker")
			.AddField(this.itemsToRemoveOvernight, "itemsToRemoveOvernight")
			.AddField(this.mailToRemoveOvernight, "mailToRemoveOvernight")
			.AddField(this.newLostAndFoundItems, "newLostAndFoundItems")
			.AddField(this.globalInventories, "globalInventories")
			.AddField(this.globalInventoryMutexes, "globalInventoryMutexes")
			.AddField(this.requestHorseWarpEvent, "requestHorseWarpEvent")
			.AddField(this.kickOutOfMinesEvent, "kickOutOfMinesEvent")
			.AddField(this.toggleMineShrineOvernight, "toggleMineShrineOvernight")
			.AddField(this.mineShrineActivated, "mineShrineActivated")
			.AddField(this.toggleSkullShrineOvernight, "toggleSkullShrineOvernight")
			.AddField(this.skullShrineActivated, "skullShrineActivated")
			.AddField(this.specialRulesRemovedToday, "specialRulesRemovedToday")
			.AddField(this.addQiGemsToTeam, "addQiGemsToTeam")
			.AddField(this.farmPerfect, "farmPerfect")
			.AddField(this.calicoEggSkullCavernRating, "calicoEggSkullCavernRating")
			.AddField(this.highestCalicoEggRatingToday, "highestCalicoEggRatingToday")
			.AddField(this.calicoStatueEffects, "calicoStatueEffects");
		this.newLostAndFoundItems.Interpolated(interpolate: false, wait: false);
		...
		this.requestSpouseSleepEvent.onEvent += OnRequestSpouseSleepEvent;
		this.requestNPCGoHome.onEvent += OnRequestNPCGoHome;
		this.requestPetWarpHomeEvent.onEvent += OnRequestPetWarpHomeEvent;
		this.requestMovieEndEvent.onEvent += OnRequestMovieEndEvent;
		this.endMovieEvent.onEvent += OnEndMovieEvent;
		this.buildingConstructedEvent.AddReaderHandler(OnBuildingConstructedEvent);
		this.buildingMovedEvent.AddReaderHandler(OnBuildingMovedEvent);
		this.buildingDemolishedEvent.AddReaderHandler(OnBuildingDemolishedEvent);
		this.ringPhoneEvent.onEvent += OnRingPhoneEvent;
		this.requestNutDrop.onEvent += OnRequestNutDrop;
		this.requestSetSimpleFlag.onEvent += OnRequestPlayerAction;
		this.requestSetMail.onEvent += OnRequestPlayerAction;
		this.requestAddCharacterEvent.onEvent += OnRequestAddCharacterEvent;
		this.addCharacterEvent.onEvent += OnAddCharacterEvent;
		this.requestLeoMove.onEvent += OnRequestLeoMoveEvent;
		this.requestHorseWarpEvent.onEvent += OnRequestHorseWarp;
		this.calicoEggSkullCavernRating.fieldChangeEvent += OnCalicoEggRatingChanged;
		...
		this.kickOutOfMinesEvent.onEvent += OnKickOutOfMinesEvent;
		this.addQiGemsToTeam.onEvent += _AddQiGemsToTeam;
	...
	public NetIntDelta GetMoney(Farmer who)
	{
		...
		{
			if (!this.individualMoney.TryGetValue(who.UniqueMultiplayerID, out var value))
			{
				NetLongDictionary<NetIntDelta, NetRef<NetIntDelta>> netLongDictionary = this.individualMoney;
	...
	public void CheckReturnedDonations()
	{
		this.returnedDonationsMutex.RequestLock(delegate
		{
			...
			foreach (Item current in this.returnedDonations)
			{
	...
	{
		if (!this.limitedNutDrops.TryGetValue(key, out var count) || count < limit)
		{
	...
	{
		if (!this.limitedNutDrops.TryGetValue(key, out var count))
		{
			return 0;
		}
		return count;
	...
	{
		this.RequestPlayerAction(new SetSimpleFlagRequest(flag, target, flagId, flagState, onlyPlayerId), this.requestSetSimpleFlag);
	}
	...
	{
		this.RequestPlayerAction(new SetMailRequest(playerTarget, mailId, mailType, add, onlyPlayerId), this.requestSetMail);
	}
	...
	{
		foreach (string item in this.broadcastedMail)
		{
	...
	{
		if (this.proposals.TryGetValue(Game1.player.UniqueMultiplayerID, out var proposal))
		{
			return proposal;
		}
		return null;
	...
	public void Update()
	{
		...
		foreach (NetMutex value in this.globalInventoryMutexes.Values)
		{
	...
	{
		if (!this.globalInventories.TryGetValue(id, out var inventory))
		{
	...
	{
		if (!this.globalInventoryMutexes.TryGetValue(id, out var mutex))
		{
