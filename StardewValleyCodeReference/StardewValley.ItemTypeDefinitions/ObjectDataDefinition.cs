...
public class ObjectDataDefinition : BaseItemDataDefinition
{
	...
	public virtual Object CreateFlavoredItem(Object.PreserveType preserveType, Object ingredient)
	{
		...
		{
			Object.PreserveType.AgedRoe => this.CreateFlavoredAgedRoe(ingredient), 
			Object.PreserveType.Honey => this.CreateFlavoredHoney(ingredient), 
			Object.PreserveType.Jelly => this.CreateFlavoredJelly(ingredient), 
			Object.PreserveType.Juice => this.CreateFlavoredJuice(ingredient), 
			Object.PreserveType.Pickle => this.CreateFlavoredPickle(ingredient), 
			Object.PreserveType.Roe => this.CreateFlavoredRoe(ingredient), 
			Object.PreserveType.Wine => this.CreateFlavoredWine(ingredient), 
			Object.PreserveType.Bait => this.CreateFlavoredBait(ingredient), 
			Object.PreserveType.DriedFruit => this.CreateFlavoredDriedFruit(ingredient), 
			Object.PreserveType.DriedMushroom => this.CreateFlavoredDriedMushroom(ingredient), 
			Object.PreserveType.SmokedFish => this.CreateFlavoredSmokedFish(ingredient), 
			_ => null, 
		};
	}
