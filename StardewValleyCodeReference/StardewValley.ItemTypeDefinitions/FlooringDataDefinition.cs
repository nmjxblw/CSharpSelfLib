...
public class FlooringDataDefinition : BaseItemDataDefinition
{
	...
	public override bool Exists(string itemId)
	{
		...
		if (this.TryParseLegacyId(itemId, out var _))
		{
			return true;
		}
		this.ParseStandardId(itemId, out var id, out var index);
	...
	public override ParsedItemData GetData(string itemId)
	{
		if (itemId != null)
		{
			if (this.TryParseLegacyId(itemId, out var legacyId))
			{
	...
	public override Item CreateItem(ParsedItemData data)
	{
		...
		if (this.TryParseLegacyId(data.ItemId, out var legacyId))
		{
			return new Wallpaper(legacyId, isFloor: true);
		}
		this.ParseStandardId(data.ItemId, out var id, out var index);
