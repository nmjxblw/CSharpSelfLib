...
public class TooManyFarmsMenu : IClickableMenu
{
	...
	public TooManyFarmsMenu()
	{
		...
		base.initialize((int)topLeft.X, (int)topLeft.Y, 800, 180);
	}
	...
	public override void draw(SpriteBatch b)
	{
		...
		this.drawBox(b, base.xPositionOnScreen, base.yPositionOnScreen, base.width, base.height);
		int pad = 35;
		string message = Game1.content.LoadString("Strings\\UI:TooManyFarmsMenu_TooManyFarms");
		SpriteText.drawString(b, message, base.xPositionOnScreen + pad, base.yPositionOnScreen + pad, 999999, base.width, base.height);
		int ypos = 260;
		Rectangle dstRect = new Rectangle(base.xPositionOnScreen + base.width - 14 - 52, base.yPositionOnScreen + base.height - 14 - 52, 52, 52);
