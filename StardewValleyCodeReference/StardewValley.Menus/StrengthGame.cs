...
public class StrengthGame : IClickableMenu
{
	...
	{
		this.power = 0f;
		this.changeSpeed = 3 + Game1.random.Next(2);
	...
	public override void update(GameTime time)
	{
		...
		else
		{
			...
			{
				this.power = 100f;
				this.changeSpeed = 0f - this.changeSpeed;
			}
			else if (this.power < 0f)
			{
				this.power = 0f;
				this.changeSpeed = 0f - this.changeSpeed;
			}
	...
	public override void draw(SpriteBatch b)
	{
		...
		if (!Game1.dialogueUp)
		{
			b.Draw(Game1.staminaRect, Game1.GlobalToLocal(Game1.viewport, new Rectangle(base.xPositionOnScreen, (int)((float)base.yPositionOnScreen - this.power / 100f * (float)base.height), base.width, (int)(this.power / 100f * (float)base.height))), Game1.staminaRect.Bounds, this.barColor * this.transparency, 0f, Vector2.Zero, SpriteEffects.None, 1E-05f);
		}
