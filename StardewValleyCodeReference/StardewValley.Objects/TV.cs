...
public class TV : Furniture
{
	...
	{
		return new TV(base.ItemId, base.tileLocation.Value);
	}
	...
	public virtual void selectChannel(Farmer who, string answer)
	{
		if (Game1.IsGreenRainingHere())
		{
			...
			this.screen = new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Rectangle(386, 334, 42, 28), 40f, 3, 999999, this.getScreenPosition(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f);
		...
		else
		{
			...
			case "Weather":
				...
				this.screen = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(413, 305, 42, 28), 150f, 2, 999999, this.getScreenPosition(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f);
				Game1.drawObjectDialogue(Game1.parseText(this.getWeatherChannelOpening()));
				Game1.afterDialogues = proceedToNextScene;
				break;
			case "Fortune":
				this.currentChannel = 3;
				this.screen = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(540, 305, 42, 28), 150f, 2, 999999, this.getScreenPosition(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f);
				Game1.drawObjectDialogue(Game1.parseText(this.getFortuneTellerOpening()));
				Game1.afterDialogues = proceedToNextScene;
				break;
			case "Livin'":
				this.currentChannel = 4;
				this.screen = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(517, 361, 42, 28), 150f, 2, 999999, this.getScreenPosition(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f);
			...
			case "The":
				...
				this.screen = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(602, 361, 42, 28), 150f, 2, 999999, this.getScreenPosition(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f);
			...
			case "???":
				...
				this.screen = new TemporaryAnimatedSprite("Maps\\springobjects", new Rectangle(112, 64, 16, 16), 150f, 1, 999999, this.getScreenPosition() + ((base.QualifiedItemId == "(F)1468") ? new Vector2(56f, 32f) : new Vector2(8f, 8f)), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, 3f, 0f, 0f, 0f);
			...
			case "Fishing":
				...
				this.screen = new TemporaryAnimatedSprite("LooseSprites\\Cursors2", new Rectangle(172, 33, 42, 28), 150f, 2, 999999, this.getScreenPosition(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f);
		...
		{
			Game1.currentLightSources.Add(new LightSource(this.GenerateLightSourceId(this.TileLocation) + "_Screen", 2, this.getScreenPosition() + ((base.QualifiedItemId == "(F)1468") ? new Vector2(88f, 80f) : new Vector2(38f, 48f)), (base.QualifiedItemId == "(F)1468") ? 1f : 0.55f, Color.Black, LightSource.LightContext.None, 0L, this.Location?.NameOrUniqueName));
		}
	}
	...
	public virtual Vector2 getScreenPosition()
	{
		...
		{
			"(F)1466" => new Vector2(base.boundingBox.X + 24, base.boundingBox.Y), 
			"(F)1468" => new Vector2(base.boundingBox.X + 12, base.boundingBox.Y - 128 + 32), 
			"(F)2326" => new Vector2(base.boundingBox.X + 12, base.boundingBox.Y - 128 + 40), 
			"(F)1680" => new Vector2(base.boundingBox.X + 24, base.boundingBox.Y - 12), 
			"(F)RetroTV" => new Vector2(base.boundingBox.X + 24, base.boundingBox.Y - 64), 
			_ => Vector2.Zero, 
		};
	}
	...
	public virtual void proceedToNextScene()
	{
		...
		case 2:
			if (this.screenOverlay == null)
			{
				...
				{
					this.screen = new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Rectangle(213, 335, 43, 28), 9999f, 1, 999999, this.getScreenPosition(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f)
					{
						id = 776
					};
				}
				...
				{
					this.screen = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(497, 305, 42, 28), 9999f, 1, 999999, this.getScreenPosition(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f)
					{
						id = 777
					};
				}
			...
			else if (Game1.player.hasOrWillReceiveMail("Visited_Island") && this.screen.id == 777)
			{
				this.screen = new TemporaryAnimatedSprite("LooseSprites\\Cursors2", new Rectangle(148, 62, 42, 28), 9999f, 1, 999999, this.getScreenPosition(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f);
				Game1.drawObjectDialogue(Game1.parseText(this.getIslandWeatherForecast()));
				this.setWeatherOverlay(island: true);
				Game1.afterDialogues = proceedToNextScene;
			}
			else
			{
		...
		case 3:
			if (this.screenOverlay == null)
			{
				...
				{
					this.screen = new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Rectangle(424, 447, 42, 28), 9999f, 1, 999999, this.getScreenPosition(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f);
				}
				else if (Game1.player.team.sharedDailyLuck.Value <= -0.1)
				{
					this.screen = new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Rectangle(424, 476, 42, 28), 9999f, 1, 999999, this.getScreenPosition(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f);
				}
				else
				{
					this.screen = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(624, 305, 42, 28), 9999f, 1, 999999, this.getScreenPosition(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 1E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f);
				}
	...
	protected virtual void setWeatherOverlay(string weatherId)
	{
		...
		{
		case "Snow":
			this.screenOverlay = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(465, 346, 13, 13), 100f, 4, 999999, this.getScreenPosition() + new Vector2(3f, 3f) * this.getScreenSizeModifier(), flicker: false, flipped: false, (float)(base.boundingBox.Bottom - 1) / 10000f + 2E-05f, 0f, Color.White, this.getScreenSizeModifier(), 0f, 0f, 0f);
			break;
		case "Rain":
	...
	protected int getRerunWeek()
	{
		...
		if (TV.weekToRecipeMap == null)
		{
			...
			{
				TV.weekToRecipeMap[Convert.ToInt32(key)] = cookingRecipeChannel[key].Split('/')[0];
			}
		}
		...
		for (int i = 1; i <= totalRerunWeeksAvailable; i++)
		{
			...
			{
				if (!item.cookingRecipes.ContainsKey(TV.weekToRecipeMap[i]))
				{
	...
	protected virtual string[] getWeeklyRecipe()
	{
		...
		try
		{
			return this.getWeeklyRecipe(cookingRecipeChannel, whichWeek.ToString());
		}
		catch
		{
			return this.getWeeklyRecipe(cookingRecipeChannel, "1");
		}
	}
