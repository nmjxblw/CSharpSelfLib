...
public class Pan : Tool
{
	...
	public override void DoFunction(GameLocation location, int x, int y, int power, Farmer who)
	{
		...
		for (int i = 0; i < base.upgradeLevel.Value - 1; i++)
		{
	...
	public List<Item> getPanItems(GameLocation location, Farmer who)
	{
		...
		roll -= (double)(base.upgradeLevel.Value - 1) * 0.05;
		if (roll < 0.01)
		{
			whichOre = "386";
		}
		...
		orePieces += base.upgradeLevel.Value - 1;
		roll = r.NextDouble() - who.DailyLuck;
		int numRolls = base.upgradeLevel.Value;
		bool gotRing = false;
		double extraChance = (double)(base.upgradeLevel.Value - 1) * 0.04;
		if (base.enchantments.Count > 0)
		{
			extraChance *= 1.25;
		}
		...
		{
			roll = r.NextDouble() - who.DailyLuck;
			roll -= (double)(base.upgradeLevel.Value - 1) * 0.005;
			whichExtra = "382";
