...
public class QuestionEvent : BaseFarmEvent
{
	...
	public override bool tickUpdate(GameTime time)
	{
		...
		if (this.whichQuestion == 2 && !Game1.dialogueUp)
		{
			...
			{
				Game1.activeClickableMenu = new NamingMenu(this.animalHouse.addNewHatchedAnimal, (this.animal != null) ? Game1.content.LoadString("Strings\\Events:AnimalNamingTitle", this.animal.displayType) : Game1.content.LoadString("Strings\\StringsFromCSFiles:QuestionEvent.cs.6692"));
			}
			return false;
		}
