...
public static class ItemQueryResolver
{
	...
	public static class DefaultResolvers
	{
		...
		public static IEnumerable<ItemQueryResult> LOST_BOOK_OR_ITEM(string key, string arguments, ItemQueryContext context, bool avoidRepeat, HashSet<string> avoidItemIds, Action<string, string> logError)
		{
			...
			return ItemQueryResolver.TryResolve(arguments, new ItemQueryContext(context, "query 'LOST_BOOK_OR_ITEM'"));
		}
		...
		public static IEnumerable<ItemQueryResult> SECRET_NOTE_OR_ITEM(string key, string arguments, ItemQueryContext context, bool avoidRepeat, HashSet<string> avoidItemIds, Action<string, string> logError)
		{
			...
			return ItemQueryResolver.TryResolve(arguments, new ItemQueryContext(context, "query 'SECRET_NOTE_OR_ITEM'"));
		}
	...
	{
		ItemQueryResolver.ItemResolvers = new Dictionary<string, ResolveItemQueryDelegate>(StringComparer.OrdinalIgnoreCase);
	...
	public static void Register(string queryKey, ResolveItemQueryDelegate queryDelegate)
	{
		...
		ItemQueryResolver.ItemResolvers[queryKey.Trim()] = queryDelegate ?? throw new ArgumentNullException("queryDelegate");
	}
	...
	public static IList<ItemQueryResult> TryResolve(ISpawnItemData data, ItemQueryContext context, ItemQuerySearchMode filter = ItemQuerySearchMode.All, bool avoidRepeat = false, HashSet<string> avoidItemIds = null, Func<string, string> formatItemId = null, Action<string, string> logError = null, Item inputItem = null)
	{
		...
		{
			obj.Item = ItemQueryResolver.ApplyItemFields(obj.Item, data, context, inputItem);
		}
		return results;
	}
	...
	{
		return ItemQueryResolver.TryResolve(query, context, ItemQuerySearchMode.RandomOfTypeItem, null, null, avoidRepeat, avoidItemIds, logError).FirstOrDefault()?.Item as Item;
	}
	...
	{
		return ItemQueryResolver.TryResolve(data, context, ItemQuerySearchMode.RandomOfTypeItem, avoidRepeat, avoidItemIds, formatItemId, logError, inputItem).FirstOrDefault()?.Item as Item;
	}
