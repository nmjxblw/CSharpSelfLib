...
public enum SaveFixes
{
	...
	BetaFixesFor16 = 82,
	/// <summary>For Stardew Valley 1.6.2, fix pre-1.6 basic wines .</summary>
	FixBasicWines = 83,
	/// <summary>For Stardew Valley 1.6.4, reset forges again.</summary>
	ResetForges_1_6 = 84,
	/// <summary>For Stardew Valley 1.6.4, grant ancient seed recipe if it was missed.</summary>
	RestoreAncientSeedRecipe_1_6 = 85,
	/// <summary>For Stardew Valley 1.6.4, fix any instanced indoor locations that are missing a unique name.</summary>
	FixInstancedInterior = 86,
	/// <summary>For Stardew Valley 1.6.4, fix any indoor locations affected by the beta-only FixAnimalHouses save fix.</summary>
	FixNonInstancedInterior = 87,
	/// <summary>For Stardew Valley 1.6.4, populate the new <see cref="F:StardewValley.FarmerTeam.constructedBuildings" /> field retroactively.</summary>
	PopulateConstructedBuildings = 88,
	/// <summary>For Stardew Valley 1.6.4, remove racoon quest from every player's quest log if it has already been completed.</summary>
	FixRacoonQuestCompletion = 89,
	/// <summary>For Stardew Valley 1.6.9, grant player the Dwarvish Translation Guide if it disappeared from the save.</summary>
	RestoreDwarvish = 90,
	/// <summary>For Stardew Valley 1.6.9, convert tub o' flowers which have item ID (BC)109 with (BC)108, since 109 is only meant to be a sprite index which (BC)108 uses.</summary>
	FixTubOFlowers = 91,
	/// <summary>For Stardew Valley 1.6.9, move the legacy stat fields like <see cref="F:StardewValley.Stats.obsolete_averageBedtime" /> into <see cref="F:StardewValley.Stats.Values" />. This is a modified version of the original 1.6 migration.</summary>
	MigrateStatFields = 92,
	/// <summary>For Stardew Valley 1.6.9, set the new <see cref="F:StardewValley.Crop.replaceWithObjectOnFullGrown" /> field so wild seeds are deterministic.</summary>
	MakeWildSeedsDeterministic = 93,
	/// <summary>For Stardew Valley 1.6.9, fix some items' internal names that were changed by translators.</summary>
	FixTranslatedInternalNames = 94,
	/// <summary>For Stardew Valley 1.6.9, convert building quests to the new <see cref="T:StardewValley.Quests.HaveBuildingQuest" /> type.</summary>
	ConvertBuildingQuests = 95,
	/// <summary>For Stardew Valley 1.6.9, retroactively set the new Junimo Kart and Prairie King stats like <see cref="F:StardewValley.Constants.StatKeys.CompletedJunimoKart" />.</summary>
	AddJunimoKartAndPrairieKingStats = 96,
	/// <summary>For Stardew Valley 1.6.15, fix lost and found items that have a 0 stack size (mainly on mobile).</summary>
	FixEmptyLostAndFoundItemStacks = 97,
	/// <summary>For Stardew Valley 1.6.15, purge duplicate mail entries that were added erroneously by <see cref="M:StardewValley.Farmer.AddMissedMailAndRecipes" />.</summary>
