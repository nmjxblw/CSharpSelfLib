...
public class BuilderData : INetObject<NetFields>
{
	...
	public BuilderData()
	{
		this.NetFields.SetOwner(this).AddField(this.buildingType, "buildingType").AddField(this.daysUntilBuilt, "daysUntilBuilt")
			.AddField(this.buildingLocation, "buildingLocation")
			.AddField(this.buildingTile, "buildingTile")
			.AddField(this.isUpgrade, "isUpgrade");
	}
