...
public class HUDMessage
{
	...
	public virtual void draw(SpriteBatch b, int i, ref int heightUsed)
	{
		...
		b.Draw(Game1.mouseCursors, itemBoxPosition, (this.messageSubject is Object obj && obj.sellToStorePrice(-1L) > 500) ? new Rectangle(163, 399, 26, 24) : new Rectangle(293, 360, 26, 24), Color.White * this.transparency, 0f, Vector2.Zero, 4f, SpriteEffects.None, 1f);
