...
public class HouseRenovation : ISalable, IHaveItemTypeId
{
	...
	/// <inheritdoc />
	public string QualifiedItemId => this.TypeDefinitionId + "HouseRenovation";
	...
	{
		Game1.activeClickableMenu = new ShopMenu("HouseRenovations", HouseRenovation.GetAvailableRenovations(), 0, null, OnPurchaseRenovation)
		{
			purchaseSound = null
		};
	}
