...
public class Summit : GameLocation
{
	...
	public override void UpdateWhenCurrentLocation(GameTime time)
	{
		if (Game1.random.NextDouble() < 0.005 || this.globalWind >= 1f || this.globalWind <= 0.35f)
		{
			...
			{
				this.windGust = (float)(-Game1.random.Next(2, 6)) / 2000f;
			}
			else
			{
		...
		if (this.wind != null)
		{
			...
			Game1.sounds.SetPitch(this.wind, 1200f + Math.Abs(this.globalWind) * 1200f);
		}
		...
		if (base.currentEvent == null && Game1.background != null && !Game1.background.cursed && base.temporarySprites.Count == 0 && Game1.random.NextDouble() < ((Game1.timeOfDay < 1800) ? 0.0006 : ((Game1.season == Season.Summer && Game1.dayOfMonth == 20) ? 1.0 : 0.001)))
		{
			...
			if (Game1.timeOfDay < 1800)
			{
				...
				case Season.Fall:
				{
					...
					for (int i = 0; i < rows; i++)
					{
						...
						base.temporarySprites.Add(bird);
				...
				if (Game1.random.NextDouble() < 0.25)
				{
					...
					base.temporarySprites.Add(bird2);
				}
				else if (Game1.random.NextDouble() < 0.15 && Game1.stats.Get("childrenTurnedToDoves") > 1)
				{
					for (int j = 0; j < Game1.stats.Get("childrenTurnedToDoves"); j++)
					{
						...
						base.temporarySprites.Add(bird3);
					}
				}
				if (Game1.MasterPlayer.eventsSeen.Contains("571102") && Game1.random.NextDouble() < 0.1)
				{
					...
					base.temporarySprites.Add(bird4);
				}
				if (Game1.MasterPlayer.eventsSeen.Contains("10") && Game1.random.NextDouble() < 0.05)
				{
					...
					base.temporarySprites.Add(bird5);
				}
			}
		...
		if (Game1.eventUp)
		{
			foreach (TemporaryAnimatedSprite temporarySprite2 in base.temporarySprites)
			{
	...
	protected override void resetLocalState()
	{
		...
		this.isShowingEndSlideshow = false;
		base.isOutdoors.Value = false;
		base.resetLocalState();
		Game1.background = new Background(this);
		base.temporarySprites.Clear();
		...
		if (!Game1.player.mailReceived.Contains("Summit_event") && Game1.MasterPlayer.mailReceived.Contains("Farm_Eternal"))
		{
			...
			if (eventScript != "")
			{
				...
				this.startEvent(new Event(eventScript));
			}
		}
	}
	...
	private void showQiCheatingEvent()
	{
		...
		this.startEvent(new Event(sb.ToString()));
		...
		try
		{
			...
			if (spouse != null && spouse.Name != "Krobus")
			{
				...
				sb.Append(spouseName).Append(" 11 13 0/skippable/viewport 10 17 clamp true/pause 2000/viewport move 0 -1 4000/move farmer 0 -10 0/move farmer 1 0 0/pause 2000/speak ").Append(spouseName)
					.Append(" \"")
					.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Intro_Spouse"))
					.Append("\"/viewport move 0 -1 4000/pause 5000/speak ")
					.Append(spouseName)
					.Append(" \"")
					.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Intro2_Spouse" + (this.sayGrufferSummitIntro(spouse) ? "_Gruff" : "")))
					.Append("\"/pause 400/emote farmer 56/pause 2000/speak ")
					.Append(spouseName)
					.Append(" \"")
					.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Dialogue1_Spouse"))
					.Append("\"/pause 1000/speak ")
					.Append(spouseName)
					.Append(" \"")
					.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Dialogue1B_Spouse"))
					.Append("\"/pause 2000/faceDirection ")
					.Append(spouseName)
					.Append(" 3/faceDirection farmer 1/pause 1000/speak ")
					.Append(spouseName)
					.Append(" \"")
					.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Dialogue2_Spouse"))
					.Append("\"/pause 2000/faceDirection ")
					.Append(spouseName)
					.Append(" 0/faceDirection farmer 0/pause 2000/speak ")
					.Append(spouseName)
					.Append(" \"")
					.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Dialogue3_" + spouseName));
			...
			{
				sb.Append("Morris 11 13 0/skippable/viewport 10 17 clamp true/pause 2000/viewport move 0 -1 4000/move farmer 0 -10 0/pause 2000/speak Morris \"").Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Intro_Morris")).Append("\"/viewport move 0 -1 4000/pause 5000/speak Morris \"")
					.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Dialogue1_Morris"))
					.Append("\"/pause 2000/faceDirection Morris 3/speak Morris \"")
					.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Dialogue2_Morris"))
					.Append("\"/pause 2000/faceDirection Morris 0/speak Morris \"")
					.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Outro_Morris"))
					.Append("\"/emote farmer 20/pause 10");
			}
			else
			{
				sb.Append("Lewis 11 13 0/skippable/viewport 10 17 clamp true/pause 2000/viewport move 0 -1 4000/move farmer 0 -10 0/pause 2000/speak Lewis \"").Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Intro_Lewis")).Append("\"/viewport move 0 -1 4000/pause 5000/speak Lewis \"")
					.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Dialogue1_Lewis"))
					.Append("\"/pause 2000/faceDirection Lewis 3/speak Lewis \"")
					.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Dialogue2_Lewis"))
					.Append("\"/pause 2000/faceDirection Lewis 0/speak Lewis \"")
					.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_Outro_Lewis"))
					.Append("\"/pause 10");
			}
			int pauseTime = 35000;
			...
			sb.Append("/playMusic moonlightJellies/pause 2000/specificTemporarySprite krobusraven/viewport move 0 -1 12000/pause 10/pause ").Append(pauseTime).Append("/pause 2000/playMusic none/viewport move 0 -1 5000/fade/playMusic end_credits/viewport -8000 -8000 true/removeTemporarySprites/specificTemporarySprite getEndSlideshow/pause 1000/playMusic none/pause 500")
				...
				.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_closingmessage"))
				.Append(" \"/spriteText 3 \"")
				.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_closingmessage2"))
				.Append(" \"/spriteText 3 \"")
				.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_closingmessage3"))
				.Append(" \"/spriteText 3 \"")
				.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_closingmessage4"))
				.Append(" \"/spriteText 7 \"")
				.Append(this.GetSummitDialogue("ExtraDialogue", "SummitEvent_closingmessage5"))
