...
public class JValue : JToken, IEquatable<JValue>, IFormattable, IComparable, IComparable<JValue>, IConvertible
{
	...
	public new object? Value
	{
		...
		set
		{
			Type obj = this._value?.GetType();
			Type type = value?.GetType();
			if (obj != type)
			{
				this._valueType = JValue.GetValueType(this._valueType, value);
			}
			this._value = value;
		}
	}
	...
	public override Task WriteToAsync(JsonWriter writer, CancellationToken cancellationToken, params JsonConverter[] converters)
	{
		...
		case JTokenType.Date:
			if (this._value is DateTimeOffset value4)
			{
		...
		case JTokenType.Guid:
			return writer.WriteValueAsync((this._value != null) ? ((Guid?)this._value) : ((Guid?)null), cancellationToken);
		case JTokenType.TimeSpan:
			return writer.WriteValueAsync((this._value != null) ? ((TimeSpan?)this._value) : ((TimeSpan?)null), cancellationToken);
		case JTokenType.Uri:
	...
	public override void WriteTo(JsonWriter writer, params JsonConverter[] converters)
	{
		...
		case JTokenType.Integer:
			...
			else if (this._value is long value6)
			{
				writer.WriteValue(value6);
			}
			else if (this._value is ulong value7)
			{
				writer.WriteValue(value7);
			}
			else if (this._value is BigInteger bigInteger)
			{
		...
		case JTokenType.Float:
			...
			else if (this._value is double value2)
			{
				writer.WriteValue(value2);
			}
			else if (this._value is float value3)
			{
		...
		case JTokenType.Bytes:
			...
			break;
		case JTokenType.Guid:
			writer.WriteValue((this._value != null) ? ((Guid?)this._value) : ((Guid?)null));
			break;
		case JTokenType.TimeSpan:
			writer.WriteValue((this._value != null) ? ((TimeSpan?)this._value) : ((TimeSpan?)null));
			break;
		case JTokenType.Uri:
	...
	TypeCode IConvertible.GetTypeCode()
	{
		...
		if (this._value is IConvertible convertible)
		{
