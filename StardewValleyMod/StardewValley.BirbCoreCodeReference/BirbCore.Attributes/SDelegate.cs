...
public class SDelegate : ClassHandler
{
	...
	public class GameStateQuery : MethodHandler
	{
		public override void Handle(MethodInfo method, object? instance, IMod mod, object[]? args = null)
		{
			GameStateQuery.Register(mod.ModManifest.UniqueID + "_" + method.Name, method.InitDelegate<GameStateQueryDelegate>(instance));
		}
	}
	...
	public class TokenParser : MethodHandler
	{
		public override void Handle(MethodInfo method, object? instance, IMod mod, object[]? args = null)
		{
			TokenParser.RegisterParser(mod.ModManifest.UniqueID + "_" + method.Name, method.InitDelegate<TokenParserDelegate>(instance));
		}
	}
