...
internal class ZlibBaseStream : Stream
{
	...
	internal ZlibBaseStream(Stream stream, CompressionMode compressionMode, CompressionLevel level, ZlibStreamFlavor flavor, bool leaveOpen)
	{
	...
	private int _ReadAndValidateGzipHeader()
	{
		...
		case 10:
		{
			...
			if ((header[3] & 4) == 4)
			{
				n = this._stream.Read(header, 0, 2);
				totalBytesRead += n;
