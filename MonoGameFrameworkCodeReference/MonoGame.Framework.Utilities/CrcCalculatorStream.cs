...
internal class CrcCalculatorStream : Stream, IDisposable
{
	...
	/// </remarks>
	internal long TotalBytesSlurped => this._Crc32.TotalBytesRead;
	...
	///   </para>
	/// </remarks>
	internal int Crc => this._Crc32.Crc32Result;
	...
	internal CrcCalculatorStream(Stream stream)
		: this(leaveOpen: true, CrcCalculatorStream.UnsetLengthLimit, stream, null)
	{
	}
	...
	internal CrcCalculatorStream(Stream stream, long length, bool leaveOpen, CRC32 crc32)
