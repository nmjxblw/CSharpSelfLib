...
internal class GZipStream : Stream
{
	...
	/// </remarks>
	internal int Crc32 => this._Crc32;
	...
	internal virtual long TotalIn => this._baseStream._z.TotalBytesIn;

	/// <summary> Returns the total number of bytes output so far.</summary>
	internal virtual long TotalOut => this._baseStream._z.TotalBytesOut;
	...
	///
	/// <para>
	///   The <see cref="T:MonoGame.Framework.Utilities.CompressionMode" /> (Compress or Decompress) also
	...
	///   to specify the compression level, see <see cref="M:MonoGame.Framework.Utilities.GZipStream.#ctor(System.IO.Stream,MonoGame.Framework.Utilities.CompressionMode,MonoGame.Framework.Utilities.CompressionLevel,System.Boolean)" />.
	/// </para>
	///
	/// <para>
	...
	///
	/// <remarks>
	///   Uncompress it with <see cref="M:MonoGame.Framework.Utilities.GZipStream.UncompressString(System.Byte[])" />.
	/// </remarks>
	///
	/// <seealso cref="M:MonoGame.Framework.Utilities.GZipStream.UncompressString(System.Byte[])" />
	/// <seealso cref="M:MonoGame.Framework.Utilities.GZipStream.CompressBuffer(System.Byte[])" />
	///
	/// <param name="s">
	...
	///
	/// <remarks>
	///   Uncompress it with <see cref="M:MonoGame.Framework.Utilities.GZipStream.UncompressBuffer(System.Byte[])" />.
	/// </remarks>
	///
	/// <seealso cref="M:MonoGame.Framework.Utilities.GZipStream.CompressString(System.String)" />
	/// <seealso cref="M:MonoGame.Framework.Utilities.GZipStream.UncompressBuffer(System.Byte[])" />
	///
	/// <param name="b">
