...
console.log('🎉官网地址: https://www.szlyuan.com/')
console.log('📖官方文档：https://www.szlyuan.com/')
console.log('💰打赏作者：https://www.szlyuan.com//doc/support.html')
console.log('📱移动端体验：https://www.szlyuan.com//h5')
</script>
