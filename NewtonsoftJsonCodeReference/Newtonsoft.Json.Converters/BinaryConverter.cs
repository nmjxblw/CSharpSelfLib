...
public class BinaryConverter : JsonConverter
{
	...
	private static void EnsureReflectionObject(Type t)
	{
		...
		{
			BinaryConverter._reflectionObject = ReflectionObject.Create(t, t.GetConstructor(new Type[1] { typeof(byte[]) }), "ToArray");
		}
	}
	...
	public override object? ReadJson(JsonReader reader, Type objectType, object? existingValue, JsonSerializer serializer)
	{
		...
		if (type.FullName == "System.Data.Linq.Binary")
		{
			...
			return BinaryConverter._reflectionObject.Creator(array);
		}
