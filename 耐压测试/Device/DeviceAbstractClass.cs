...
namespace ZH
{
    ...
    /// 科陆CLT11协议接收数据包基类
    /// </summary>
    internal abstract class ZHRecvPacket_CLT11 : ReceivePacket
    {
        /// <summary>
        /// 包头
        /// </summary>
        protected byte PacketHead = 0x4E;
        ///// <summary>
        ///// 发信节点
        ///// </summary>
    ...
    internal abstract class ZHSendPacket_CLT11 : SendPacket
    {
        ...
        /// 包尾
        /// </summary>
        protected byte PacketTail = 0x45;
        /// <summary>
        /// 发信节点
        /// </summary>
        ...
        public override byte[] GetPacketData()
        {
            ...
            if (body == null)
                return null;
            //byte packetLength = (byte)(body.ParameterLength + 5);//帧头4字节+CS一字节
        ...
        {
            //byte bytChkSum = 0x00;
            //for (int int_Inc = 1; int_Inc < bytData.ParameterLength; int_Inc++)
            //{
            //    bytChkSum ^= bytData[int_Inc];
            //}
            //return bytChkSum;
            byte chk = 0x00;
            //for (int i = 1; i < data.ParameterLength; i++)
            //    chk ^= data[i];
    ...
    /// CLT11协议接收数据包基类
    /// </summary>
    internal abstract class CLT11RecvPacket : ReceivePacket
    {
