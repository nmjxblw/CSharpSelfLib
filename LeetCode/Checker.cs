...
namespace LeetCode
{
    ...
    internal class Checker
    {
        ...
        /// 成员缓存
        /// </summary>
        private ConcurrentDictionary<Type, MemberInfo[]> MemberCache { get; } =
        ...
        {
            MemberInfo[] members = MemberCache.GetOrAdd(
                type,
                t => t.GetProperties().Cast<MemberInfo>().Concat(t.GetFields()).ToArray()
            );
