...
namespace Dopamine
{
    ...
    public class DynamicClass : DynamicObject
    {
        ...
        public object? this[int index]
        {
            get
            {
                return _properties.Values.ToList()[index];
            }
        }
        /// <summary>
        /// 获取所有属性
        ...
        public static implicit operator string?(DynamicClass dynamicClass)
        {
            return JsonSerializer.Serialize<DynamicClass>(dynamicClass, new JsonSerializerOptions()
            {
        ...
        /// </summary>
        /// <param name="value"></param>
        public static implicit operator DynamicClass(string value)
        {
            return JsonSerializer.Deserialize<DynamicClass>(value, new JsonSerializerOptions()
            {
                PropertyNameCaseInsensitive = true,
                WriteIndented = true,
                IgnoreReadOnlyFields = true,
